...
# 
#     ! Enable ACL, FIB, and L2 monitoring
#     icam monitor resource acl_tcam module 1 inst 0
#     icam monitor resource fib_tcam module 1 inst 0
#     icam monitor resource l2_table module 1 inst 0
#
...
def setup_nxos():
    ...
    command = copy.deepcopy(payload_template)
    command['params']['cmd'] = 'icam monitor resource acl_tcam module 1 inst 0'
    command['id'] = 3
    payload.append(command)

    command = copy.deepcopy(payload_template)
    command['params']['cmd'] = 'icam monitor resource fib_tcam module 1 inst 0'
    command['id'] = 4
    payload.append(command)

    command = copy.deepcopy(payload_template)
    command['params']['cmd'] = 'icam monitor resource l2_table module 1 inst 0'
    command['id'] = 5
    payload.append(command)
